...
public class GeminiService {
    ...
    public String suggestTeamName() {
        ...
        String inputText = "Suggest 3 original, professional, and inspiring team name for a team in the construction field, just give me the team name.";
    ...
    private String extractSuggestionsFromJson(String jsonResponse) {
        try {
            ...
            StringBuilder suggestions = new StringBuilder("Here are some team name suggestions. :\n");
