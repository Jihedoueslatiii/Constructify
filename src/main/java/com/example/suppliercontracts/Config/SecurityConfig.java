package com.example.suppliercontracts.Config;
...
public class SecurityConfig {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/api/suppliers/register",       // Endpoint d'inscription
                                "/api/suppliers/all",           // Lister tous les utilisateurs
                                "/api/suppliers/{id}",           // Obtenir un utilisateur par ID
                                "/api/suppliers/users/role/${role}",          // Endpoint de connexion
                                "/api/suppliers/user/update/**"       // Mettre à jour un utilisateur
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:4200"));  // Permet Angular
